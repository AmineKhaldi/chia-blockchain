...
@pytest.mark.parametrize("old", [True, False])
@pytest.mark.anyio
async def test_exploration(old: bool) -> None:
    LAUNCHER_ID = bytes32([1] * 32)
    PARENT_PARENT = bytes32([2] * 32)
    ...
    sb2_conds = make_test_conds(
        spend_ids=[(singleton_spend.coin, ELIGIBLE_FOR_FF), (TEST_COIN, 0)],
        created_coins=[[(singleton_spend.coin.puzzle_hash, 1, None)], []],
        cost=1337,
    )
    bundle_add_info2 = await mempool_manager.add_spend_bundle(sb2, sb2_conds, sb2.name(), uint32(1))
    ...
    create_block = mempool_manager.create_block_generator if old else mempool_manager.create_block_generator2
    assert mempool_manager.peak is not None
    block_generator = create_block(mempool_manager.peak.header_hash)
...
class CheckRemovalsCase:
    ...
    regular_spend_coin_ids: list[bytes32]
    fast_forward_coin_ids: set[bytes32]
    items_spending_regular_coin_ids: list[MempoolItem]
    items_spending_ff_coins: dict[bytes32, list[MempoolItem]]
    expected_result: tuple[Optional[Err], list[MempoolItem]]
    marks: Marks = ()
...
@datacases(
    CheckRemovalsCase(
        id="No removals",
        removals={},
        regular_spend_coin_ids=[],
        fast_forward_coin_ids=set(),
        items_spending_regular_coin_ids=[],
        items_spending_ff_coins={},
        expected_result=(None, []),
    ),
    CheckRemovalsCase(
        id="Unspent removal, no mempool conflicts",
        removals={TEST_COIN_ID: TEST_COIN_RECORD},
        regular_spend_coin_ids=[TEST_COIN_ID],
        fast_forward_coin_ids=set(),
        items_spending_regular_coin_ids=[],
        items_spending_ff_coins={},
        expected_result=(None, []),
    ...
    CheckRemovalsCase(
        ...
        removals={TEST_COIN_ID: make_coin_record(TEST_COIN, spent_block_index=1)},
        regular_spend_coin_ids=[],
        fast_forward_coin_ids={TEST_COIN_ID},
        items_spending_regular_coin_ids=[],
        items_spending_ff_coins={},
        expected_result=(None, []),
    ),
    CheckRemovalsCase(
        ...
        fast_forward_coin_ids={TEST_COIN_ID},
        items_spending_regular_coin_ids=[],
        items_spending_ff_coins={TEST_COIN_ID: [mk_item([TEST_COIN])]},
    ...
    CheckRemovalsCase(
        ...
        fast_forward_coin_ids={TEST_COIN_ID},
        items_spending_regular_coin_ids=[],
        items_spending_ff_coins={TEST_COIN_ID: [mk_item([TEST_COIN], flags=[ELIGIBLE_FOR_FF])]},
        expected_result=(None, []),
    ),
    CheckRemovalsCase(
        id="Non FF coin, mempool conflict",
        removals={TEST_COIN_ID: TEST_COIN_RECORD},
        regular_spend_coin_ids=[TEST_COIN_ID],
        fast_forward_coin_ids=set(),
        items_spending_regular_coin_ids=[mk_item([TEST_COIN])],
        items_spending_ff_coins={},
        expected_result=(Err.MEMPOOL_CONFLICT, [mk_item([TEST_COIN])]),
    ),
    CheckRemovalsCase(
        ...
        regular_spend_coin_ids=[TEST_COIN_ID],
        fast_forward_coin_ids={TEST_COIN_ID2},
        items_spending_regular_coin_ids=[mk_item([TEST_COIN])],
        items_spending_ff_coins={TEST_COIN_ID2: [mk_item([TEST_COIN2])]},
    ...
    CheckRemovalsCase(
        ...
        fast_forward_coin_ids={TEST_COIN_ID2},
        items_spending_regular_coin_ids=[mk_item([TEST_COIN])],
        items_spending_ff_coins={TEST_COIN_ID2: [mk_item([TEST_COIN2], flags=[ELIGIBLE_FOR_FF])]},
        expected_result=(Err.MEMPOOL_CONFLICT, [mk_item([TEST_COIN])]),
    ),
    CheckRemovalsCase(
        ...
        removals={TEST_COIN_ID: TEST_COIN_RECORD, TEST_COIN_ID2: TEST_COIN_RECORD2},
        regular_spend_coin_ids=[],
        fast_forward_coin_ids={TEST_COIN_ID, TEST_COIN_ID2},
        items_spending_regular_coin_ids=[],
        items_spending_ff_coins={
    ...
    CheckRemovalsCase(
        ...
        removals={TEST_COIN_ID: TEST_COIN_RECORD, TEST_COIN_ID2: TEST_COIN_RECORD2},
        regular_spend_coin_ids=[TEST_COIN_ID, TEST_COIN_ID2],
        fast_forward_coin_ids=set(),
        # Same item spends both coins
        items_spending_regular_coin_ids=[mk_item([TEST_COIN, TEST_COIN2])],
        items_spending_ff_coins={},
...
def test_check_removals(case: CheckRemovalsCase) -> None:
    result = check_removals(
        regular_spend_coin_ids=case.regular_spend_coin_ids,
        removals=case.removals,
        fast_forward_coin_ids=case.fast_forward_coin_ids,
        get_items_spending_ff_coin=lambda coin_id: iter(case.items_spending_ff_coins.get(coin_id, [])),
        get_items_spending_regular_coin_ids=lambda _: case.items_spending_regular_coin_ids,
    )
